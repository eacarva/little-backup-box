...
// 			allowed parameters
	...
	if ($CMD !== '') {
		...
		switch($CMD) {
			...
			case 'update_development':
				$COMMAND_LINE	= "sudo python3 $WORKING_DIR/lib_display.py ':" . L::box_cmd_update_start1 . "' ':" . L::box_cmd_update_start2 . "'";
				$COMMAND_LINE	.= ";sudo -u pi curl -sSL https://raw.githubusercontent.com/eacarva/little-backup-box/development/install-little-backup-box.sh -o ~pi/install-little-backup-box.sh";
