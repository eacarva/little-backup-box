...
- OLED: uma mensagem por tela (sem histórico), QR do IP só quando muda, barra de status com o IP
  e alertas (HOT, temperatura), só na última linha e só quando ela está livre.
